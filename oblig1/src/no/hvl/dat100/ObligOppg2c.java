...
public class ObligOppg2c {
	public static void main(String[] args) {
		...
		for (int i = 0; i < 10; i++) {
			...
			String karakter;
			// bruker en do while loop for å sørge for at koden blir kjørt en gang før while condition blir sjekket
			do {
				...
				if (karakter.equals("Ugyldig")) {
					...
					System.out.print("Forsøk å skrive inn poengsum på nytt: ");
				} else {
					System.out.println(
							"Studenten fikk karakteren " + karakter + " med poengsummen " + poengsum);
				}
			} while (karakter.equals("Ugyldig"));
		}
		inputScanner.close();
	}
}
